...
export const pythonTopics: Topic[] = [
  {
    id: "google-colab",
    title: "Google Colab",
    description: "Colab is a hosted Jupyter Notebook service that requires no setup to use and provides free of charge access to computing resources, including GPUs and TPUs. Colab is especially well suited to machine learning, data science, and education.",
    points: [
      {
  ...
  },
  {
    ...
    description: "Python is a versatile, high-level, interpreted programming language known for its readability and extensive libraries. It was created by Guido van Rossum in the late 1980s and first released in 1991. Python is used for various tasks, including data analysis, machine learning, web development, and automation",
    points: [
      {
        text: "Python is a high-level, interpreted programming language with easy syntax and dynamic semantics.",
        highlights: ["high-level", "interpreted", "easy syntax", "dynamic semantics"]
      },
      {
      ...
      },
      {
        ...
        highlights: ["web development", "data analysis", "artificial intelligence", "scientific computing"]
      },
      {
  ...
  },
  {
    id: "data-types",
    title: "Data Types",
    description: "Data types in Python define the kind of value a variable can hold. Python is a dynamically typed language, meaning you don’t need to declare the type of a variable explicitly. It automatically detects the data type at runtime. ",
    points: [
      {
        text: "Python has several built-in data types including numbers, strings, lists, tuples, sets, and dictionaries.",
        highlights: ["numbers", "strings", "lists", "tuples", "sets", "dictionaries"]
      },
      {
      ...
      },
      {
        ...
        highlights: ["tuples", "immutable", "Lists", "mutable", "Dictionaries", "Sets", "Booleans", "None", "Typed conversion"],
      ...
      },
      {
        ...
        highlights: ["sequences", "single quotes", "double quotes", "triple quotes"],
        code: "name = 'John'\nmessage = \"Hello, World!\"\nparagraph = '''This is a\nmulti-line string'''"
      },
      {
  ...
  },
  {
    ...
    description: "Keywords are reserved words in Python that have special meanings and cannot be used as variable names. They are used to define the structure of the program and the operations that can be performed on the data.",
    points: [
      {
        text: "Python has several built-in data types including numbers, strings, lists, tuples, sets, and dictionaries.",
        highlights: ["numbers", "strings", "lists", "tuples", "sets", "dictionaries"]
  ...
  },
  {
    ...
    points: [
      ...
      },
      {
        ...
        highlights: ["Context managers", "with statement", "resource management"]
      },
      {
