        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div>
            <h2 className="text-xl font-medium text-zinc-200">
              Python Quiz - {level.charAt(0).toUpperCase() + level.slice(1)} Level
            </h2>
            <div className="flex items-center mt-1 space-x-3">
              <div className="text-xs text-zinc-400">Question {currentIndex + 1} of {questions.length}</div>
              <div className="h-1 w-full max-w-[200px] bg-zinc-700 rounded-full overflow-hidden">
                <motion.div 
          ...
          <motion.div 
            className={`glassmorphism py-2 px-4 rounded-full flex items-center ${timer < 300 ? 'text-red-400' : 'text-zinc-200'}`}
            animate={timer < 300 ? { 
              scale: [1, 1.05, 1],
              backgroundColor: ['rgba(26, 26, 37, 0.7)', 'rgba(220, 38, 38, 0.2)', 'rgba(26, 26, 37, 0.7)'],
            } : {}}
