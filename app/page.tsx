...
export default function HomePage() {
  ...
  const statsData = useMemo(
    () => [
      {
        number: calculateTotalQuestions(),
        label: "Questions",
        icon: <FaQuestion />,
      },
  ...
  return (
    <>
      ...
      <main className="h-full container mx-auto px-4 py-8 bg-gradient-to-br from-zinc-900 via-zinc-800 to-black text-white relative overflow-hidden">
        <BackgroundParticles />
        ...
        <div className="container mx-auto px-4 py-12 max-w-6xl space-y-20">
          ...
          >
            ...
            >
              ...
              >
                <span className="h1 font-para">Python Quiz Master</span>
              </motion.h1>
            </motion.div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {statsData.map((stat, index) => (
                ...
                >
                  ...
                  >
                    <span className="bg-zinc-800/50 text-indigo-300 p-1.5 rounded-full">
                      {stat.icon}
                    </span>
                  </motion.div>
