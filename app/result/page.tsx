...
export default function ResultPage() {
  ...
  const generatePDF = () => {
    ...
    doc.text(
      `Score: ${correctCount}/${total} (${percentage.toFixed(2)}%)`,
      14,
      46
    );
    ...
    doc.text(copyrightText, pageWidth / 2, pageHeight - 10, {
      align: "center",
    });
      ...
      <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-zinc-800 to-black text-white">
        <div className="max-w-4xl mx-auto px-4 py-10">
          ...
          >
            ...
            >
              <span
                className={`bg-gradient-to-r ${resultColor} bg-clip-text text-transparent font-semibold`}
              >
                {resultMessage}
              </span>
            </motion.p>
...
<div className="grid justify-center items-center w-full grid-cols-2 gap-6">
          ...
          >
                  ...
                  {data.questions.map((q, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td
                          className={`px-4 py-3 ${
                            !q.userAnswer ? "text-zinc-500 italic" : ""
                          }`}
                        >
                          {q.userAnswer || "Not Answered"}
                        </td>
            ...
            <div className="flex justify-center mt-8 space-x-4">
              ...
              <motion.button
                onClick={() =>
                  router.push(`/quiz?topic=${topic}&level=${level}`)
                }
